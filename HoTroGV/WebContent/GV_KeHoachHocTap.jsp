...
<head>
	...
	<script>
		function them(){
			...
			var nkt = document.getElementById("nkt");
			if (nbd.value =="") {
				document.getElementById('error-nbd').innerHTML = "Vui lòng nhập Ngày bắt đầu";
				nbd.style.borderColor ="red";
				
			}
			else {
				document.getElementById('error-nbd'). innerHTML = "";
				nbd.style.borderColor ="green"
			}

			if (nkt.value =="") {
				document.getElementById('error-nkt').innerHTML = "Vui lòng nhập Ngày kết thúc";
				nkt.style.borderColor ="red";
				
			}
			else if (nkt.value < nbd.value) {
				document.getElementById('error-nkt').innerHTML = "Ngày kết thúc phải lớn hơn Ngày bắt đầu";
				nkt.style.borderColor ="red";
				
			}
			else {
				document.getElementById('error-nkt'). innerHTML = "";
				...
				<div class="modal-body">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="nbd" placeholder="Example: 2016/08/15">
								<div id ="error-nbd" style="color: red; font-style: italic;"></div>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3"  style="text-align: left">Ngày kết thúc</label>
							
							<div class="col-sm-9">
								<input type="text" class="form-control" id="nkt" placeholder="Example: 2016/08/21"">
								<div id ="error-nkt" style="color: red; font-style: italic;"></div>
							</div>
						</div>
						<div class="form-group">
