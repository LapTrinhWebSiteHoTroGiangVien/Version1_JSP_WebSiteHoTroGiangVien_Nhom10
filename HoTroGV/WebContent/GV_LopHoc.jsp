				...
				<div class="modal-body">
					<form class="form-horizontal">
					    ...
					    <div class="form-group">
					        ...
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="t_ngaybatdau" placeholder="VD: 2016/08/22">
					            <div id="error-t_ngaybatdau" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        ...
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="t_ngayketthuc" placeholder="VD: 2016/12/22">
					            <div id="error-t_ngayketthuc" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
				...
				<div class="modal-body">
					<form class="form-horizontal">
					    <div class="form-group">
					    	<label class="control-label col-sm-4" for="TenLopHoc">Tên lớp học:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="tenlophoc_cs" placeholder="Nhập tên lớp học">
					            <div id ="error-tenlophoc_cs" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        <label class="control-label col-sm-4" for="NgayBatDau">Ngày bắt đầu:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="ngaybatdau_cs" placeholder="VD: 2016/08/22">
					            <div id="error-ngaybatdau_cs" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        <label class="control-label col-sm-4" for="NgayKetThuc">Ngày kết thúc:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="ngayketthuc_cs" placeholder="VD: 2016/12/22">
					            <div id="error-ngayketthuc_cs" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        <label class="control-label col-sm-4" for="LichHoc">Lịch học:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="lichhoc_cs" placeholder="VD: Thứ 2, Tiết 7-11, Tuần 2-16, Phòng A2-302c">
					            <div id="error-lichhoc_cs" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					...
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-8">
							    ...
							    <div id="error-tieude" style="color: red; font-style: italic;" align="left"></div>
							</div>
						</div>
						...
						<div class="form-group">
					        <label class="control-label col-sm-4" for="NgayBatDau">Ngày bắt đầu:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="ngaybatdau_tth" placeholder="VD: 2016/08/22">
					            <div id="error-ngaybatdau_tth" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        <label class="control-label col-sm-4" for="NgayKetThuc">Ngày kết thúc:</label>
					        <div class="col-sm-8">
					            <input type="text" class="form-control" id="ngayketthuc_tth" placeholder="VD: 2016/08/28">
					            <div id="error-ngayketthuc_tth" style="color: red; font-style: italic;" align="left"></div>
					        </div>
					    </div>
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick = "themtuanhoc()">Thêm</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
				</div>
			</div>
		</div>
