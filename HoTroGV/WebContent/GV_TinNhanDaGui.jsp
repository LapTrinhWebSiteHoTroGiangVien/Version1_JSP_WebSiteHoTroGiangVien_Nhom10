	...
	<style type="text/css">
     .scroll{
        ...
        overflow:scroll;
  		...
  		<script>
  		function clickTN(){
  			window.location = "GV_TinNhanDaNhan.jsp"
  		}
  	</script>
</head>
<body>
		  	...
		  	<div class="panel panel-primary">
				 ...
				 <div class="panel-body">
				 	<div class="btn-group-vertical">
				 		<button type="button" class="btn btn-primary" onclick = "clickTN()"><a href="GV_TinNhanDaNhan.jsp" style="color: white">Tin nhắn đã nhận</a></button>
