...
<head>
	...
	<script>
		function nopbai(){
			window.location = "SinhVien_NopBai2.jsp"
		}
	</script>
</head>
<body>
			      ...
			      <div class="panel-body">
			      		<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								  <button type="button" class="btn btn-primary" onclick = "nopbai()"><span class="glyphicon glyphicon-edit"></span><a href="SinhVien_NopBai2.jsp" style="text-decoration: none; color: white"> Nộp bài</a></button>
								  
