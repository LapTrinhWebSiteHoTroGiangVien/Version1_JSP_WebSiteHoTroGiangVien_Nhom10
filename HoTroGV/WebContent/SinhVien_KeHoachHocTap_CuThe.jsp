  ...
  <div class="container">
    <div class="panel panel-primary">
      ...
      <table class="table">           
        <thead>
          <tr>
          	<th style="background-color: #337ab7; font-size: 20px; color: white"><h3><strong><a href="SinhVien_KeHoachHocTap.jsp"><span class="glyphicon glyphicon-chevron-left"></span></a> 19/9/2016 đến 25/9/2016: Cơ bản về ứng dụng Web</strong></h3></th>
          </tr>
        </thead>
        <tbody>
          <tr>
