...
<head>
  ...
  <script type="text/javascript">
    function myfun(){
      var flag = true;
      var td = document.getElementById('tieude');
     
      if (td.value =="") {
        document.getElementById('error-tieude').innerHTML ="Vui lòng nhập tiêu đề bài nộp";
          ...
          <form class="form-horizontal" id="formData">
            ...
            <div class="form-group">
             <label class="control-label col-sm-2" for="Save">Nội dung</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="noidung" placeholder="Nhập nội dung hoặc mô tả">
                <div id="error-noidung" style="color: red; font-style: italic;"></div>
              </div>
            </div>
          </form>
