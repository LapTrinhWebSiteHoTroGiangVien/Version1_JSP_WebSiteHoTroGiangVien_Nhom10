...
<head>
	...
	<script>
  		function clickTN(){
  			window.location = "SinhVien_TinNhanDaGui.jsp"
  		}
  	</script>
</head>
<body>
		  	...
		  	<div class="panel panel-primary">
				 ...
				 <div class="panel-body">
				 	<div class="btn-group-vertical">
				 		...
				 		<button type="button" class="btn btn-primary" onclick = "clickTN()"><a href="SinhVien_TinNhanDaGui.jsp" style="color: white">Tin nhắn đã gửi</a></button>
